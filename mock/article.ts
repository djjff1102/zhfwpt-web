...
export default [
  {
    url: "/dev-api/api/v1/article/list",
    timeout: 200,
    method: "get",
    response: ({ query }) => {
  ...
  {
    url: "/dev-api/api/v1/article/detail",
    timeout: 200,
    method: "get",
    response: ({ query }) => {
      const { id } = query;
  ...
  {
    url: "/dev-api/api/v1/article/update",
    timeout: 200,
    method: "post",
    response: ({ body }) => {
  ...
  {
    url: "/dev-api/api/v1/article/create",
    timeout: 200,
    method: "post",
    response: ({ body }) => {
  ...
  {
    url: "/dev-api/api/v1/article/delete",
    timeout: 200,
    method: "post",
    response: ({ body }) => {
      const { id } = body;
